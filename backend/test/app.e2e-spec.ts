      ...
      it('without parameters - returns all open posts', async () => {
        ...
        expect(body[0]).toEqual(
          expect.objectContaining({
            ...
            startDateTime: '2022-11-07T00:15:00.000Z',
            endDateTime: '2022-11-07T15:59:00.000Z',
            type: 'buyer',
            id: '1d1bd429-291e-449c-80fd-54cdb236a075',
            telegramAlertMessageId: null,
            status: 'open',
            creatorProfile: {
              userId: '4394cce2-7f04-41f2-8ade-8b21cad1cb20',
              name: 'Alison',
      ...
      it('with search params - returns filtered posts', async () => {
        ...
        expect(body[0]).toEqual(
          expect.objectContaining({
            ...
            openToClimbTogether: true,
            optionalNote: 'Hello! Nice to meet you!',
            startDateTime: '2022-11-06T00:15:00.000Z',
            endDateTime: '2022-11-06T07:15:00.000Z',
            type: 'buyer',
            telegramAlertMessageId: null,
            status: 'closed',
            creatorProfile: {
