            ...
            <div className="max-w-3xl mx-auto">
              <article>
                ...
                <header className="mb-8">
                  ...
                  <div className="text-center md:text-left">
                    <h1
                      ...
                      data-aos="fade-down"
                    >
                      ClimbJios launches new thematic solutions
                    </h1>
                    <p
                ...
                >
                  <p className="mb-8">
                    <strong className="font-medium text-gray-900 dark:text-gray-100">
                      There’s nothing more damaging to aspiring entrepreneurs
                      than mere inaction
                    </strong>
                  ...
                  <p className="mb-8">
                    ...
                    posuere morbi leo urna molestie turpis in eu mi bibendum
                    neque egestas. Est ante in nibh mauris cursus mattis
                    molestie aliquam purus sit amet luctus vulputate sapien nec
                    sagittis aliquam enim nec dui nunc mattis enim, sit amet
                    nulla facilisi morbi tempus iaculis urna id. Blandit cursus
                  ...
                  <p className="mb-8">
                    ...
                    sit amet luctus vulputate sapien nec sagittis aliquam enim
                  ...
                  <p className="mb-8">
                    ...
                    augue ut lectus arcu bibendum at non sodales neque sodales
                    ut etiam sit. Venenatis urna cursus eget nunc scelerisque
                  ...
                  <blockquote className="italic pl-4 border-l-2 border-teal-500 dark:border-gray-400 mb-8">
                    ...
                    decisions you’re going to ever have to make is what you’re
                    not going to do.”
                  </blockquote>
                  <h3 className="h4 font-red-hat-display mb-4 text-gray-900 dark:text-gray-100">
                    4. Final Thoughts
                  ...
                  <p className="mb-8">
                    ...
                    ut tortor pretium viverra suspendisse potenti justo eget
                    magna fermentum, iaculis eu non diam phasellus nisl suscipit
                    adipiscing bibendum est, dolor sed viverra ipsum nunc
                    aliquet bibendum enim facilisis gravida. Integer feugiat
                ...
                <footer>
                  {/* Newsletter module */}
                  <div
                    className="bg-gray-800 py-8 px-8 md:py-12 md:px-12 text-center text-gray-100"
                    data-aos="fade-down"
                  >
                    ...
                    <form>
                      <div className="relative flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-sm sm:px-4">
                        ...
                        />
                        <a
                          className="btn-sm text-white bg-primary hover:bg-teal-400 shrink-0"
                          href="#0"
                        >
                          Subscribe
                        </a>
